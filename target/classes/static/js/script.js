...
for (var i = 0; i < statearray.length; i++){
	var opt = document.createElement("option");
  	document.getElementById("state").innerHTML += '<option id="' + i + '">' + statearray[i] + '</option>';
}*/

let cityarray = ["Choose City","Jaipur", "Jodhpur", "Kota", "Bhiwadi", "Bikaner", "Udaipur","Ajmer", "Bhilwara", "Alwar","Sikar", "Bharatpur", "Sikar", "Pali", 
				"SriGanganagar", "Kishangarh", "Baran", "Dhaulpur", "Tonk", "Beawar", "Hanumangarh", "Banswara", "Dungarpur", "Pratapgarh"]


for (var i = 0; i < cityarray.length; i++){
	var opt = document.createElement("option");
	cityarray = cityarray[i];
	if (cityarray.selected){
		document.getElementById("city").innerHTML += '<option id="' + i + '" selected = "selected">' + cityarray[i] + '</option>';
	} else {
		document.getElementById("city").innerHTML += '<option id="' + i + '">' + cityarray[i] + '</option>';
	}
...
function opendialogue(id){
	var result = confirm("Are you sure to want to delete this product?");
